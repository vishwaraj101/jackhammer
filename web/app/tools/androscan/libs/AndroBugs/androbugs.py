...
def get_hash_scanning(writer) :
	...
	tmp_original = writer.getInf("package_name", "pkg") + "-" + writer.getInf("file_sha256", "sha256") + "-" + str(time.time()) + "-" + str(secrets.SystemRandom().randrange(10000000, 99999999))
...
def get_hash_exception(writer) :
	...
	tmp_original = writer.getInf("analyze_error_id", "err") + "-" + writer.getInf("file_sha256", "sha256") + "-" + str(time.time()) + "-" + str(secrets.SystemRandom().randrange(10000000, 99999999))
	tmp_hash = hashlib.sha512(tmp_original).hexdigest()
	return tmp_hash
